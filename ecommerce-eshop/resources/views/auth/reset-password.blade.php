                ...
                <div class="card border-0 shadow-lg rounded-5 overflow-hidden">
                    <div class="card-body p-5">
                        <div class="text-center mb-5">
                            <h1 class="h3 fw-black text-dark mb-2">{{ __('messages.new_password_title') }}</h1>
                            <p class="text-muted">{{ __('messages.create_new_password') }}</p>
                        </div>
                        ...
                        <form method="POST" action="{{ route('password.update') }}">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="email"
                                    ...
                                    name="email" value="{{ old('email', $email ?? '') }}" placeholder="example@mail.com" required
                                    autofocus dir="ltr">
                            </div>

                            <div class="mb-4">
                                <label for="password" class="form-label fw-bold small text-secondary">{{ __('messages.new_password') }}</label>
                                <input type="password"
